...
5. **Health check.** Issue an HTTP GET to `HEALTH_URL`. Acceptable response: HTTP 200 status code. Any other status (4xx, 5xx, timeout, network error) — treat as failure.
