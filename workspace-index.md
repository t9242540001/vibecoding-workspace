...
- `templates/site-audit/` — reusable scope, full-audit scope, test-data/access, marketing/AI/agentic checklist, report, taxonomy, and Codex live-audit prompt templates for safe website audits.
- `docs/site-audit/` — reusable site-audit research basis, full-agent v2 research/charter, live browser interactive audit contract, marketing/AI/agentic readiness standard, agentic audit pipeline, validation gates, and browser/E2E integration review.
