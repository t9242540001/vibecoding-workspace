...
- 2026-05-12 — v1.2.0: Discipline reinforcement after Batch A (ai-knowledge-system, 2026-05-11) retrospective. No content changes in this guide; the corresponding rules live in `standards/batch-execution-standard.md` v1.2 — Section 13 (Pre-commit Verification), Section 14 (Foundation As Separate Bootstrap PR), Section 15 (Branch Discipline). Open the standard for the actionable details; this guide remains the onboarding entry point.
